...
- What will the output binaries look like? 
  - MacOSX/Linux: `diff ConsoleApp/bin/Debug/net10.0/ConsoleApp.dll ConsoleApp2/bin/Debug/net10.0/ConsoleApp.dll`
  - Windows: `fc ConsoleApp/bin/Debug/net10.0/ConsoleApp.dll ConsoleApp2/bin/Debug/net10.0/ConsoleApp.dll`
...
- Run string on the binaries and create text files to compare with e.g. VS Code or any other preferred tool
  - MacOSX/Linux:
    - `strings ConsoleApp/bin/Debug/net10.0/ConsoleApp.dll >> ConsoleAppStrings`
    - `strings ConsoleApp2/bin/Debug/net10.0/ConsoleApp.dll >> ConsoleApp2Strings`
  - Windows:
    - `more < ConsoleApp/bin/Debug/net10.0/ConsoleApp.dll | findstr "." >> ConsoleAppStrings`
    - `more < ConsoleApp2/bin/Debug/net10.0/ConsoleApp.dll | findstr "." >> ConsoleApp2Strings`
